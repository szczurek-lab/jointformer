...
class ModelOutput(dict):
    ...
    def __init__(self, embeddings, cls_embeddings=None, lm_embeddings=None, loss=None, logits_generation=None, logits_prediction=None, logits_physchem=None, attention_mask=None):
        super().__init__(
