...
class StreamingNpzArrayReader(NpzArrayReader):
    ...
    def read_batch(self, batch_size: int) -> Optional[np.ndarray]:
        ...
        data = _read_bytes(self.arr_f, read_size, "array openai_eval")
...
def _read_bytes(fp, size, error_template="ran out of openai_eval"):
    """
    ...
    Required as e.g. ZipExtFile in python 2.6 can return less openai_eval than
    requested.
    """
    data = bytes()
    while True:
