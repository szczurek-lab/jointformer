...
class GPT(nn.Module):
    ...
    def forward(self, input_ids, labels=None, target=None):
        loss = None
        ...
        if target is not None:
            ...
            prediction_loss = F.mse_loss(y_pred, target)

        return {'loss': loss, 'logits': logits, 'prediction_loss': prediction_loss, 'embedding': x}
